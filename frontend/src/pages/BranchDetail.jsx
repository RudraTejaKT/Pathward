...
const TABS = ["Roadmap", "Projects", "Job Roles"];
  ...
  if (loading) {
    return (
      <main className="container branch-detail__status">
        <p className="mono">Loading roadmap…</p>
      </main>
    );
  }
    ...
    <main>
      <section className="branch-detail-hero">
        <div className="container">
          <PathTrail stages={JOURNEY_STAGES} activeIndex={3} />
          <Link to="/engineering" className="branch-detail__back">
            ← All branches
          </Link>
        ...
        <div className="container">
            ...
            <div className="roadmap-list">
              {!user && (
                <p className="mono progress-hint">
                  <Link to="/login">Log in</Link> to track which stages you've completed.
                </p>
              )}
              {roadmap.map((stage, i) => {
                ...
                <div className={`roadmap-stage ${done ? "roadmap-stage--done" : ""}`} key={stage.stage}>
                  ...
                  <div className="roadmap-stage__body">
                    ...
                    <div className="roadmap-stage__group">
                      <p className="roadmap-stage__label mono">CORE SUBJECTS</p>
                    ...
                    <div className="roadmap-stage__group">
                      <p className="roadmap-stage__label mono">SKILLS TO LEARN</p>
                      <div className="roadmap-stage__chips">
          ...
          {activeTab === "Projects" && (
            <div className="project-grid">
              {!user && (
                <p className="mono progress-hint">
                  <Link to="/login">Log in</Link> to check off projects as you build them.
                </p>
              )}
              {projects.map((p) => {
